    ...
    data() {
      return {
        ...
        buyListFirst: [
          ...
          {'title': 'Step2：', 'info': '点击「我要买币」，并可通过筛选下拉箭头进行广告的筛选和排序。'},
          {'title': 'Step3：', 'info': '点击「购买BTC」，输入你想购买的人民币数量金额和BTC数量(需符合卖家额度)，之后确认购买金额及对应的数字币数量，阅读并同意OTC购买流程规则后勾选小方框，并点击「购买」按钮。'},
          {'title': 'Step4：', 'info': '创建订单后，联系卖家是否在线。如果在线，则可以转款。在规定交易期限转款后请务必点击「标记已付款」按钮。转款后请不要点击「取消交易」按钮。如果支付时间不足，请点击「重建订单」按钮。'},
          {'title': 'Step5：', 'info': 'Step5：等待卖家放币至您的MIXOTC账户。交易结束。'}
        ],
        buyListSecond: [
          {'title': 'Step1：', 'info': '点击右上角的＋，发布购买广告，选择购买的币种，溢价，以及交易的最小，最大限额等信息，最后点击「发布」按钮。'},
          {'title': 'Step2：', 'info': '当有用户下单之后，APP内会有消息通知。手机登陆用户会发送短信通知，邮箱登陆则会发送邮件通知。'},
          {'title': 'Step3：', 'info': '在规定交易期限中付款给卖家，并点击「标记已付款」按钮，转款后请不要点击「取消交易」按钮。如果支付时间不足，请点击「重建订单」按钮。'},
          {'title': 'Step4：', 'info': '等待卖家放币至您的MIXOTC账户。'}
        ],
        saleListFirst: [
          {'title': 'Step1：', 'info':'在MIXOTC上使用电话号码或者邮箱注册一个账号。'},
          {'title': 'Step2：', 'info':'在卖出BTC之前，请您先充值BTC至您的MIXOTC账户。'},
          {'title': 'Step3：', 'info':'点击「我要卖币」，并可通过筛选下拉箭头进行广告的筛选和排序。'},
          {'title': 'Step4：', 'info':'点击「出售BTC」，输入你想出售的人民币数量金额和BTC数量(需符合买家额度)，之后确认出售金额及对应的数字币数量，阅读并同意OTC出售流程规则后勾选小方框，并点击「出售」按钮。'},
          {'title': 'Step5：', 'info':'创建订单后，与买家沟通，等待买家付款，买家付款确认后，您需要仔细检查款项是否已经到账。只有在确认到账之后才可以点击「释放币」按钮，并可对买家做出评价，交易完成。'}
        ],
        saleListSecond: [
          {'title': 'Step1：', 'info':'当买家下单后，您的数字货币将被平台锁定。'},
          {'title': 'Step2：', 'info':'创建订单后，与买家沟通，等待买家付款，买家付款确认后，您需要仔细检查款项是否已经到账。只有在确认到账之后才可以点击「释放币」按钮，并可对买家做出评价，交易完成。'}
        ],
        serviceList: [
