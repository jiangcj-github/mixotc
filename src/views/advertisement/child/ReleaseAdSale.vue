<template>
  <div class="release-ad-info">
    ...
    <ol>
      ...
      <li class="input-li">
        <p class="num-p clearfix">
          ...
          <strong :class="{selected: selectNum}" @click="showVary">随可用余额变动</strong>
        </p>
    ...
    <ol>
      ...
      <li>
        <button class="release-btn" @click="initData()">发布出售广告</button>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.Bus.$on('saleRelease', data => { // 接收出售信息
    ...
    methods: {
      ...
      // resetInfo() {
      //   // this.currency = 'coinTitle'
      //   // this.payment = 0
      //   // this.selectNum = false
      //   this.switchValue = false
      //   // this.premium = 0
      //   // this.limit = 0
      //   this.priceValue = this.adTabIndex == 2 && (this.$store.state.adMessageBuy ? this.$store.state.adMessageBuy.price : '') || (this.$store.state.adMessageSale ? this.$store.state.adMessageSale.price : '')
      //   // this.numValue =''
      //   // this.minValue = ''
      //   // this.maxValue = ''
      //   // this.textVale = ''
      //   console.log('111', this.switchValue)
      // },
      initData() { // 发布广告
